            ...
            <div className=' w-full bg-[#e4e0de] py-10'>
                ...
                <div className=''>
                    ...
                    <label htmlFor="toggle2" id="switch1" >
                        <div id="circle2" className='flex justify-center items-center bouncy-button'>
                ...
                <div className='flex justify-center item-center py-10'>
                    <button className='sm:w-[10rem] sm:h-[3rem] w-[8rem] h-[2.5rem] rounded-full sm:text-[20px] text-[15px] bouncy-button font-semibold bg-[#95bf46]'>Learn more</button>
                </div>
            </div>
        </>
    )
